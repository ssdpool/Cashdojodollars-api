...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\CashDojoDollars\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/CashDojoDollars/';
  if (isLinux) dataDir = process.env.HOME + '/.CashDojoDollars/';
}
